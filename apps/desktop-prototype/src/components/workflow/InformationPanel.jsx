import { AgencyCardPicker } from "./AgencyCardPicker.jsx";

export function InformationPanel({ infoDraft, agencyId, onChangeInfo, onSelectAgency, onConfirm }) {
  return <div className="workflow-panel" data-panel="information">
    ...
    <label className="workflow-field"><span>담당 부서</span><input id="info-department" value={infoDraft.department || ""} placeholder="예: 교학과" onChange={(event) => onChangeInfo("department", event.target.value)} /></label>
    <div className="workflow-field"><span>기관</span><AgencyCardPicker value={agencyId} onSelect={onSelectAgency} /></div>
